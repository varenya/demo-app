...
export type GetPokemonQuery = { __typename?: 'Query', getFuzzyPokemon: Array<{ __typename?: 'Pokemon', key: PokemonEnum, sprite: string, num: number, species: string, color: string, abilities: { __typename?: 'Abilities', first: { __typename?: 'Ability', name: string }, second?: { __typename?: 'Ability', name: string } | null, special?: { __typename?: 'Ability', name: string } | null } }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getPokemon(variables: GetPokemonQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetPokemonQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetPokemonQuery>(GetPokemonDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getPokemon', 'query');
    }
  };
}
